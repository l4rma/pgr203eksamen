...
public class OptionTagTasksWithCurrentStatusGetController implements HttpController {
    private TaskDao taskDao;

    public OptionTagTasksWithCurrentStatusGetController(TaskDao taskDao) {
    ...
    public void handle(HttpRequest request, Socket clientSocket) throws IOException, SQLException, NoSuchAlgorithmException {
            ...
            for (Task task : taskDao.list()) {
                body.append("<option value='" + task.getTaskId() + "'>" +
